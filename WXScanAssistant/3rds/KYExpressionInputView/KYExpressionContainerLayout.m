...
//    }
    ...
    if (UIInterfaceOrientationIsPortrait(orientation) || orientation == UIInterfaceOrientationUnknown) {
        return value.uintegerForOrientationPortrait;
    }
    else {
        return value.uintegerForOrientationLandscape;
...
//    UIDeviceOrientation oriention = [[UIDevice currentDevice] orientation];
    ...
    BOOL isPortrait = UIInterfaceOrientationIsPortrait(oriention);//UIDeviceOrientationIsPortrait(oriention);
    // 个数有改变
