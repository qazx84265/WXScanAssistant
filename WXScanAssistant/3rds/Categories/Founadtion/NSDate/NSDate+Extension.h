 ...
 *  获取星期几
 *
 *  @return 1 Return weekday number
 *  [1 - Sunday]
 *  [2 - Monday]
 *  [3 - Tuerday]
 *  [4 - Wednesday]
 ...
 *  获取星期几(名称)
 *
 *  @return 1 Return weekday as a localized string
 *  [1 - Sunday]
 *  [2 - Monday]
 *  [3 - Tuerday]
 *  [4 - Wednesday]
 ...
 *  @return 1 Return YES if is same day, NO if not
 */
 ...
 *  是否是今天
 *
 *  @return 1 Return if self is today
 */
- (BOOL)isToday;
 ...
 *  @return 1 Return self by adding the gived days number
 */
